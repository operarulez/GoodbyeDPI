...
- **[DPI Tunnel CLI](https://github.com/nomoresat/DPITunnel-cli)** by @nomoresat (for Linux and routers)
- **[DPI Tunnel for Android](https://github.com/nomoresat/DPITunnel-android)** by @nomoresat (for Android)
- **[PowerTunnel](https://github.com/krlvm/PowerTunnel)** by @krlvm (for Windows, MacOS and Linux)
- **[PowerTunnel for Android](https://github.com/krlvm/PowerTunnel-Android)** by @krlvm (for Android)
- **[SpoofDPI](https://github.com/xvzc/SpoofDPI)** by @xvzc (for macOS and Linux)
- **[GhosTCP](https://github.com/macronut/ghostcp)** by @macronut (for Windows)
- **[ByeDPI](https://github.com/hufrea/byedpi)** by @hufrea (for Linux)
- **[ByeDPI for Android](https://github.com/dovecoteescapee/ByeDPIAndroid)** by @dovecoteescapee (for Android)
